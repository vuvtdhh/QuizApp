    ...
    public partial class frmLamBaiTracNghiem : Form
    {
        ...
        private void frmLamBaiTracNghiem_Load(object sender, EventArgs e)
        {
            ...
            using (DatabaseDataContext db = new DatabaseDataContext())
            {
                ...
                {
                    MessageBox.Show("Kỳ thi đã kết thúc!", "Thông Báo", MessageBoxButtons.OK);
                    this.Close();
                }
                else
                {
                    //Lấy mã đề mà những thí sinh này được thi.
                    var made = db.KyThis.Where(tt => tt.DanhSachThiSinh.Contains(stt.ToString())).Select(tt => tt.DanhSachDeThi).ToArray();
        ...
        private void btnCauSau_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn đã hoàn thành bài thi! Kết quả của bạn sẽ được lưu lại!", "Thông Báo", MessageBoxButtons.OK);
                this.Close();
            }     
